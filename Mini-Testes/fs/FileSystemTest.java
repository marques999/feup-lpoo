...
{
	public static void testCreateFileSystem() throws DuplicateNameException
	{
	...
	public static void testFileSystemRoot() throws DuplicateNameException
	{
		FileSystem fs = new FileSystem("FAT32");
	...
	public static void testCreateNodes() throws DuplicateNameException
	{
		FileSystem fs = new FileSystem("FAT32");
		Folder root = fs.getRoot();
	...
	public static void testFolderContents() throws DuplicateNameException
	{
		FileSystem fs = new FileSystem("FAT32");
		Folder root = fs.getRoot();
		Node node1 = new Folder(root, "bin");
	...
	public static void testGetChildByName() throws DuplicateNameException
	{
		FileSystem fs = new FileSystem("FAT32");
		Folder root = fs.getRoot();
		Node node1 = new Folder(root, "bin");
	...
	public static void testDuplicateName() throws DuplicateNameException
	{
		FileSystem fs = new FileSystem("FAT32");
		Folder root = fs.getRoot();
		Node node1 = new Folder(root, "bin");
	...
	public static void testAutoNumber() throws DuplicateNameException
	{
	...
	public static void testSize() throws DuplicateNameException
	{
		FileSystem fs = new FileSystem("FAT32");
		Folder root = fs.getRoot();
	...
	public static void testPathNameFormatter() throws DuplicateNameException
	{
		...
		FileSystem.setNameFormatter(unix);
		assertEquals("/etc/crontab", crontab.getPath());

		FileSystem.setNameFormatter(dos);
		assertEquals("\\etc\\crontab", crontab.getPath());
	}

	public static void testDeepClone() throws DuplicateNameException
	{
		FileSystem fs = new FileSystem("FAT32");
		Folder root = fs.getRoot();
		Folder etc = new Folder(root, "etc");
		...
		assertEquals(crontab, crontab2); // mas com o mesmo conteúdo (nome,
											// tamanho)
	}
	...
	//
	// // não se pode mover um nó para debaixo dele próprio ou de um
	// descendente,
